...
def main():
    ...
    #todo d_parser.add_argument('url', type=str)
    ...
    #todo d_parser.add_argument('--common-words', type=file, required=True, metavar='', help='REQUIRED Newline-delimited file of common words to be used in page guessing and input guessing.')
